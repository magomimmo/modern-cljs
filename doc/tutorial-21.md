...
but we could have chosen any of the other builds as well, because
...
because the `:whitespace` build that we have selected to be augmented
...
First we augmented the project with the `:dev` profile and we also
