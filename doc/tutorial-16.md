...
namespace. Even if at the moment that namespace lives only on the
server-side of `modern-cljs` web app, we already arranged it to make
it movable on the client-side too.
