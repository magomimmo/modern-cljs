...
discover that there two options to be passed to the CLJS compiler:
...
project and set the `asset-path` option to che CLJS compiler. That's.
...
Now that a look at the layout if the `target` directory to confirm
